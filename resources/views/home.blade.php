{{--  
      Membasdat Application
      Version: 1.0
      Author: @Geri Tri Panca Tamba (https://github.com/bubblevy)
...
<html lang="id">
      <head>
            ...
            <link rel="stylesheet" href="{{ asset('homepage/css/animate.css') }}"><link rel="stylesheet" href="{{ asset('homepage/css/owl.carousel.min.css') }}">
            <link rel="stylesheet" href="{{ asset('homepage/css/owl.theme.default.min.css') }}">
            <link rel="stylesheet" href="{{ asset('homepage/css/magnific-popup.css') }}"><link rel="stylesheet" href="{{ asset('homepage/css/aos.css') }}">
            <link rel="stylesheet" href="{{ asset('homepage/css/style.css') }}">

            <style>
            @media screen and (min-width:1000px){.height-300{height:270px}}
            @media screen and (min-width:768px) and (max-width:1000px){.height-300{height:400px}}
            </style>
                        ...
                        <ul class="navbar-nav nav ml-auto">
                              <li class="nav-item">
                                    <a href="#home-section" class="nav-link">
                                          <span>
                                                <i class="bx bx-home" style="font-size:16px"></i>&nbsp;Beranda
                                          </span>
                                    </a>
                              </li>
                              <li class="nav-item">
                                    <a href="#menu-aplikasi" class="nav-link">
                                          <span>
                                                <i class="bx bxs-grid-alt" style="font-size:16px"></i>&nbsp;Menu Aplikasi
                                          </span>
                                    </a>
                              </li>
                              <li class="nav-item">
                                    <a href="#layanan" class="nav-link">
                                          <span>
                                                <i class="bx bx-wrench" style="font-size:16px"></i>&nbsp;Layanan
                                          </span>
                                    </a>
                              </li>@if(Auth::check()) @if(auth()->user()->is_admin)
                              <li class="nav-item">
                                    <a href="/admin/dashboard" class="nav-link">
                                          <span>
                                                <i class="bx bx-desktop" style="font-size:16px"></i>&nbsp;Dashboard
                                          </span>
                                    </a>
                              </li>@else
                              <li class="nav-item">
                              ...
                              <li class="nav-item">
                                    <a href="/login" class="nav-link">
                                          <span>
                                                <i class="bx bx-log-in-circle" style="font-size:16px"></i>&nbsp;Masuk
                                          </span>
                                    </a>
                              </li>
                              <li class="nav-item">
                                    <a href="/register" class="nav-link">
                                          <span>
                                                <i class="bx bx-user" style="font-size:16px"></i>&nbsp;Daftar
                                          </span>
                                    </a>
                              </li>@endif
                        </ul>
      ...
      <section id="home-section" class="hero">
            <div class="home-slider owl-carousel">
                  <div class="slider-item">
                        ...
                        <div class="container">
                              <div class="d-flex slider-text align-items-center justify-content-center">
                                          <div class="text-center">
                                                <h1 class="mb-4 mt-3">Aplikasi Belajar <span>Basis Data</span></h1>
                                                <p><a href="/register" class="btn btn-primary py-3 px-4" style="color:#fff!important">Gabung Sekarang</a></p>
                                          </div>
                                    </div>
                              </div>
                        </div>
      ...
      <section class="ftco-section ftco-no-pt ftco-no-pb ftco-counter img" id="section-counter">
            <div class="container">
                  <div class="row d-md-flex align-items-center">
                        <div class="col-md d-flex justify-content-center counter-wrap ftco-animate">
                              <div class="block-18">
                                    <div class="text"><strong class="number" data-number="{{ $users }}">0</strong>
                  ...
                  <div class="col-md d-flex justify-content-center counter-wrap ftco-animate">
                        <div class="block-18">
                              <div class="text"><strong class="number" data-number="{{ $quizzes }}">{{ $quizzes }}</strong>
            ...
            <div class="col-md d-flex justify-content-center counter-wrap ftco-animate">
                  <div class="block-18">
                        <div class="text"><strong class="number" data-number="{{ $threads }}">{{ $threads }}</strong>
            ...
            <div class="row">
                  <div class="col-md-6">
                        ...
                        <div class="resume-wrap ftco-animate height-300">
                              ...
                              <p class="mt-4">Dalam pengaturan, pengguna dapat melihat dan mengubah identitas diri seperti nama, alamat, foto profil dll. Pengguna juga dapat mengubah password.</p>
                        </div>
                  </div>
                  <div class="col-md-6">
                        <div class="resume-wrap ftco-animate height-300">
                              <span class="date">Forum</span><p class="mt-4">Forum digunakan untuk berdiskusi jika terdapat masalah mengenai materi yang ada. Setiap pengguna bisa mengajukan pertanyaan dan nantinya pertanyaan tersebut bisa dijawab oleh pengguna lain.</p>
                        </div>
                        <div class="resume-wrap ftco-animate height-300">
                              <span class="date">Nilai</span>
                              <p class="mt-4">Setiap selesai menjawab quiz, pengguna dapat melihat nilainya langsung di menu 'Nilai'. Pengguna juga dapat melihat pertanyaan mana saja yang jawabannya benar dan juga salah. Selain itu, pengguna juga bisa menghapus histori mengerjakan quiznya.</p>
                        </div>
                        <div class="resume-wrap ftco-animate height-300">
                              <span class="date">Dokumentasi</span><p class="mt-4">Dalam dokumentasi, pengguna dapat melihat tutorial bagaimana cara menggunakan aplikasi. Mulai dari membuat akun, melihat materi, mengerjakan quiz, melihat nilai quiz, mengubah password, dan masih banyak lagi.</p>
                        </div>
                  </div>
            </div>
      </div>
            ...
            <div class="row">
                  ...
                  <div class="col-md-4 text-center d-flex ftco-animate">
                        <a class="services-1">
                              ...
                              <div class="desc">
                                    <h3 class="mb-5">Quiz dan Evaluasi</h3>
                              </div>
                        </a>
                  </div>
                  <div class="col-md-4 text-center d-flex ftco-animate">
                  ...
                  <div class="col-md-4 text-center d-flex ftco-animate">
                        <a class="services-1">
                              ...
                              <div class="desc">
                                    <h3 class="mb-5">Bantuan dan Dukungan</h3>
                              </div>
                        </a>
                  </div>
                  <div class="col-md-4 text-center d-flex ftco-animate">
                  ...
                  <div class="col-md">
                        <div class="ftco-footer-widget mb-4 ml-md-4">
                              ...
                              <ul class="list-unstyled">
                                    <li>
                                          <a href="/">
                                                <span class="bx bx-right-arrow-alt mr-2"></span>Home
                                          </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                          <a href="/materi">
                                                <span class="bx bx-right-arrow-alt mr-2"></span>Materi
                                          </a>
                                    </li>
                                    <li>
                                          <a href="/quiz">
                                                <span class="bx bx-right-arrow-alt mr-2"></span>Quiz
                                          </a>
                                    </li>@endif @endif
                              </ul>
                        </div>
                  ...
                  <div class="col-md">
                        <div class="ftco-footer-widget mb-4">
                              ...
                              <ul class="list-unstyled">
                                    <li>
                                          <a href="/docs/v1">
                                                <span class="bx bx-right-arrow-alt mr-2"></span>Dokumentasi
                                          </a>
                                    </li>
                                    <li>
                                          <a href="/view/discuss">
                                                <span class="bx bx-right-arrow-alt mr-2"></span>Forum
                                          </a>
                                    </li>
                              </ul>
                        </div>
                              ...
                              <div class="block-23 mb-3">
                                    <ul>
                                          <li>
                                                ...
                                                <span class="text"> Kp. Gantungan, Bandung Barat, Jawa Barat, Indonesia</span>
                                          </li>
                                          <li>
                                                <a href="javascript:void()">
                                                      <span class="bx bx-phone mr-2"></span>
                                                      <span class="text">+62887-0638-2919</span>
                                                </a>
                                          </li>
                                          <li>
                                                <a href="javascript:void()">
                                                      <span class="bx bx-envelope mr-2"></span>
                                                      <span class="text">geripanca5@gmail.com</span>
                                                </a>
                                          </li>
                                    </ul>
                              </div>
...
<div id="ftco-loader" class="show fullscreen">
      <svg class="circular" width="48px" height="48px">
            <circle class="path-bg" cx="24" cy="24" r="22" fill="none" stroke-width="4" stroke="#eeeeee"/><circle class="path" cx="24" cy="24" r="22" fill="none" stroke-width="4" stroke-miterlimit="10" stroke="#696cff"/>
      </svg>
</div>
